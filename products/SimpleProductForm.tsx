...
export const SimpleProductForm: React.FC<SimpleProductFormProps> = ({ productId, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Dimensions (inches)</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value: 'inches' | 'feet' | 'mm') => 
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, minWidth: Number(e.target.value) }))}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, minHeight: Number(e.target.value) }))}
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, defaultWidth: Number(e.target.value) }))}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, defaultHeight: Number(e.target.value) }))}
                />
              </div>
            </div>
          </CardContent>
